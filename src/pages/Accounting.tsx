...
export default function Accounting() {
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto pb-8">
      {/* Header */}
      <div>
        <h1 className="text-4xl font-heading font-semibold text-brand-blue dark:text-[#F7F7F7] tracking-tight">Finance</h1>
        <p className="text-brand-blue/50 dark:text-[#A0A0A0] mt-1 font-medium uppercase text-[10px] tracking-[0.2em]">Complete financial health overview</p>
      </div>
      ...
      <div className="flex bg-neutral-100 dark:bg-[#1A1A1A] p-1.5 rounded-2xl">
        <button onClick={() => setActiveTab('overview')} className={`flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl font-semibold text-xs uppercase tracking-[0.15em] transition-all ${activeTab === 'overview' ? 'bg-brand-blue text-white shadow-lg' : 'text-brand-blue/40 dark:text-[#A0A0A0]'}`}>
          <BarChart3 className="w-4 h-4" /> Overview
        </button>
        <button onClick={() => setActiveTab('periods')} className={`flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl font-semibold text-xs uppercase tracking-[0.15em] transition-all ${activeTab === 'periods' ? 'bg-brand-blue text-white shadow-lg' : 'text-brand-blue/40 dark:text-[#A0A0A0]'}`}>
        ...
        <>
          ...
          <div className="relative overflow-hidden rounded-[24px] bg-brand-blue dark:from-[#1C1C24] dark:via-[#1E1A22] dark:to-[#1C1F26] p-6 shadow-xl border border-white/5">
            ...
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-sm font-semibold text-white/60 uppercase tracking-widest">Current Net Worth</span>
            </div>
            <p className="text-4xl sm:text-5xl font-heading font-semibold tracking-tight text-white">
              ₹{currentNetWorth.toLocaleString('en-IN', { minimumFractionDigits: 2 })}
            </p>
            <div className="mt-4 pt-4 border-t border-white/10 grid grid-cols-3 gap-4">
              <div>
                <p className="text-xs text-white/50 font-medium">Total Earned</p>
              ...
              <div>
                <p className="text-xs text-white/50 font-medium">Transactions</p>
                <p className="text-lg font-heading font-semibold">{totalTxCount}</p>
              </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div className="bg-white dark:bg-[#111111] rounded-2xl border border-brand-blue/5 dark:border-[#222222] p-4 shadow-sm group hover:border-brand-green/30 transition-colors">
              <div className="flex items-center gap-1.5 mb-2">
                ...
                <span className="text-[11px] font-semibold text-brand-blue/40 dark:text-[#A0A0A0] uppercase tracking-[0.2em]">Income</span>
              </div>
              <p className="text-xl font-heading font-semibold text-brand-green tracking-tight">₹{thisMonthIncome.toLocaleString('en-IN')}</p>
            ...
            <div className="bg-white dark:bg-[#111111] rounded-2xl border border-brand-blue/5 dark:border-[#222222] p-4 shadow-sm group hover:border-brand-red/30 transition-colors">
              <div className="flex items-center gap-1.5 mb-2">
                ...
                <span className="text-[11px] font-semibold text-brand-blue/40 dark:text-[#A0A0A0] uppercase tracking-[0.2em]">Expenses</span>
              </div>
              <p className="text-xl font-heading font-semibold text-brand-red tracking-tight">₹{thisMonthExpense.toLocaleString('en-IN')}</p>
            ...
            <div className="bg-white dark:bg-[#111111] rounded-2xl border border-[#EBEBEB] dark:border-[#222222] p-4 shadow-[0_8px_30px_rgba(0,0,0,0.08)]">
              <div className="flex items-center gap-1.5 mb-2">
                ...
                <span className="text-[11px] font-semibold text-[#525252] dark:text-[#A0A0A0] uppercase tracking-[0.2em]">Savings</span>
              </div>

              <p className={`text-xl font-heading font-semibold tracking-tight ${thisMonthSavings >= 0 ? 'text-brand-green' : 'text-brand-red'}`}>
            ...
            <div className="bg-white dark:bg-[#111111] rounded-2xl border border-[#EBEBEB] dark:border-[#222222] p-4 shadow-[0_8px_30px_rgba(0,0,0,0.08)]">
              <div className="flex items-center gap-1.5 mb-2">
                ...
                <span className="text-[11px] font-semibold text-[#525252] dark:text-[#A0A0A0] uppercase tracking-[0.2em]">Savings Rate</span>
              </div>

              <p className={`text-xl font-heading font-semibold tracking-tight ${savingsRate >= 20 ? 'text-brand-green' : savingsRate >= 0 ? 'text-brand-gold' : 'text-brand-red'}`}>
          ...
          <div className="bg-white dark:bg-[#111111] rounded-3xl border border-brand-blue/5 dark:border-[#222222] shadow-sm p-6">
            <h2 className="text-lg font-heading font-semibold text-brand-blue dark:text-[#F7F7F7] mb-1 flex items-center gap-2">
              ...
              {monthlyTrend.map(m => {
                ...
                return (
                  <div key={m.month} className="flex-1 flex flex-col items-center gap-1 h-full justify-end group">
                    ...
                    <span className="text-[10px] font-bold text-brand-blue/40 dark:text-[#A0A0A0] mt-1 uppercase tracking-wider">{m.label}</span>
                  </div>
            ...
            <div className="flex items-center gap-4 mt-6 justify-center">
              <div className="flex items-center gap-1.5"><div className="w-2.5 h-2.5 bg-brand-green rounded-sm" /><span className="text-[10px] font-semibold uppercase tracking-[0.2em] text-brand-blue/40">In</span></div>
              <div className="flex items-center gap-1.5"><div className="w-2.5 h-2.5 bg-brand-red rounded-sm" /><span className="text-[10px] font-semibold uppercase tracking-[0.2em] text-brand-blue/40">Out</span></div>
            </div>
          ...
          <div className="bg-white dark:bg-[#111111] rounded-3xl border border-brand-blue/5 dark:border-[#222222] shadow-sm p-6">
            ...
            <p className="text-xs font-medium text-brand-blue/30 dark:text-[#666666] mb-4">Live liquid overview</p>
                  ...
                  return (
                    <div key={acc.id} className="flex items-center justify-between p-4 bg-neutral-50 dark:bg-[#1A1A1A] rounded-xl border border-[#EBEBEB] dark:border-[#222222]">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-semibold text-brand-blue dark:text-[#F7F7F7] text-sm">{acc.bankName}</p>
                          {acc.accountLast4 && <p className="text-[10px] text-brand-blue/40 dark:text-[#666666] font-semibold uppercase tracking-[0.2em] leading-none">••••{acc.accountLast4}</p>}
                        </div>
                      </div>
                      <p className={`font-heading font-semibold text-lg tracking-tight ${bal >= 0 ? 'text-brand-blue dark:text-[#F7F7F7]' : 'text-brand-red'}`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-[#111111] rounded-3xl border border-brand-blue/5 dark:border-[#222222] shadow-sm p-6">
              ...
              <p className="text-xs font-medium text-brand-blue/30 dark:text-[#666666] mb-4">{format(now, 'MMMM yyyy')}</p>
                  ...
                  {categoryBreakdown.map(cat => (
                    <div key={cat.name}>
                      <div className="flex justify-between items-center mb-1">
                        <span className="text-sm font-semibold text-brand-blue dark:text-[#F7F7F7]">{cat.name}</span>
                        <span className="text-sm font-heading font-semibold text-brand-blue dark:text-[#F7F7F7] tracking-tight">₹{cat.value.toLocaleString('en-IN')}</span>
                      </div>
                      <HBar value={cat.value} max={maxCategoryValue} color={getCategoryColor(cat.name)} />
                      <p className="text-[10px] font-semibold text-brand-blue/30 dark:text-[#666666] mt-1 uppercase tracking-[0.2em]">{thisMonthExpense > 0 ? ((cat.value / thisMonthExpense) * 100).toFixed(1) : 0}% OF MONTHLY SPEND</p>
                    </div>
            ...
            <div className="bg-white dark:bg-[#111111] rounded-3xl border border-brand-blue/5 dark:border-[#222222] shadow-sm p-6">
              ...
              <p className="text-xs font-medium text-brand-blue/30 dark:text-[#666666] mb-4">Highest volume merchants</p>
                  ...
                  {topParties.map((p, i) => (
                    <div key={p.name} className="flex items-center gap-3 p-3 bg-neutral-50 dark:bg-[#1A1A1A] rounded-xl border border-[#EBEBEB] dark:border-[#222222]">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-semibold text-brand-blue dark:text-[#F7F7F7] truncate">{p.name}</p>
                        <p className="text-[10px] font-semibold text-brand-blue/40 dark:text-[#666666] uppercase tracking-[0.2em]">{p.count} transaction{p.count > 1 ? 's' : ''}</p>
                      </div>
                      <p className="font-heading font-semibold text-brand-red text-sm shrink-0 tracking-tight">₹{p.total.toLocaleString('en-IN')}</p>
                    </div>
                  ...
                  <div className="p-5 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 cursor-pointer" onClick={() => setExpandedMonth(isExpanded ? null : monthStr)}>
                    <div className="flex items-center gap-3 flex-1">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          <h2 className="text-lg font-semibold text-[#222222] dark:text-[#F7F7F7]">{format(monthDate, 'MMMM yyyy')}</h2>
                    ...
                    <div className="flex items-center gap-3 w-full sm:w-auto">
                      <div className="flex-1 sm:flex-none text-right sm:text-left mr-2">
                        <p className="text-[10px] font-semibold text-brand-blue/30 dark:text-[#666666] uppercase tracking-[0.2em]">Closing</p>
                        <p className="text-xl font-heading font-semibold text-brand-blue dark:text-[#F7F7F7] tracking-tight">₹{data.closingBalance.toLocaleString('en-IN')}</p>
                      </div>
                  ...
                  {isExpanded && (
                    <div className="border-t border-[#EBEBEB] dark:border-[#222222]">
                      ...
                      <div className="p-6 grid grid-cols-2 sm:grid-cols-4 gap-4">
                        <div>
                          <p className="text-[10px] font-semibold text-brand-blue/30 dark:text-[#A0A0A0] mb-1 uppercase tracking-[0.2em]">Opening</p>
                          <p className="text-xl font-heading font-semibold text-brand-blue dark:text-[#F7F7F7] tracking-tight">₹{data.openingBalance.toLocaleString('en-IN')}</p>
                        </div>

                        <div>
                          <p className="text-[10px] font-semibold text-brand-blue/30 dark:text-[#A0A0A0] mb-1 flex items-center gap-1 uppercase tracking-[0.2em]"><TrendingUp className="w-3.5 h-3.5 text-brand-green" /> In</p>
                          <p className="text-xl font-heading font-semibold text-brand-green tracking-tight">+₹{data.totalIncome.toLocaleString('en-IN')}</p>
                        </div>
                        <div>
                          <p className="text-[10px] font-semibold text-brand-blue/30 dark:text-[#A0A0A0] mb-1 flex items-center gap-1 uppercase tracking-[0.2em]"><TrendingDown className="w-3.5 h-3.5 text-brand-red" /> Out</p>
                          <p className="text-xl font-heading font-semibold text-brand-red tracking-tight">-₹{data.totalExpense.toLocaleString('en-IN')}</p>
                        </div>
                        <div>
                          <p className="text-[10px] font-semibold text-brand-blue/30 dark:text-[#A0A0A0] mb-1 flex items-center gap-1 uppercase tracking-[0.2em]"><Wallet className="w-3.5 h-3.5" /> Close</p>
                          <p className="text-2xl font-heading font-bold text-brand-blue dark:text-[#F7F7F7] tracking-tight">₹{data.closingBalance.toLocaleString('en-IN')}</p>
                        </div>
                      ...
                      {data.isClosed && (
                        <div className="px-6 pb-4">
                          <h3 className="text-xs font-semibold text-[#717171] dark:text-[#A0A0A0] uppercase tracking-[0.2em] mb-3">Account Balances at Close</h3>
                              ...
                              return (
                                <div key={accountId} className="flex items-center justify-between p-3 bg-neutral-50 dark:bg-[#1A1A1A] rounded-xl border border-[#EBEBEB] dark:border-[#222222]">
                                  <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm font-semibold text-brand-blue dark:text-[#F7F7F7]">{account.bankName}</span>
                                  </div>
                                  <span className="text-sm font-heading font-semibold text-brand-blue dark:text-[#F7F7F7] tracking-tight">₹{(balance as number).toLocaleString('en-IN')}</span>
                      ...
                      <div className="px-6 pb-5 flex justify-end">
                        {data.isClosed ? (
                          <button onClick={() => handleReopenMonth(monthStr)} className="px-5 py-2.5 text-xs font-semibold text-brand-blue dark:text-[#F7F7F7] bg-white dark:bg-[#111111] border border-brand-blue/10 rounded-xl hover:bg-brand-blue/5 transition-colors uppercase tracking-[0.2em] scale-95 hover:scale-100">
                            Reopen
                          </button>
                        ) : (
                          <button onClick={() => handleCloseMonth(monthStr)} className="px-5 py-2.5 text-xs font-semibold text-white dark:text-[#111111] bg-brand-blue rounded-xl hover:bg-brand-blue/90 transition-colors uppercase tracking-[0.2em] shadow-lg shadow-brand-blue/20 scale-95 hover:scale-100">
                            Close Period
                          </button>
                        )}
