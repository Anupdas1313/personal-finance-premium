                ...
                {accList.map(account => {
                  ...
                  return (
                    <div 
                      ...
                      className="bg-[#F9FBFF] dark:bg-[#111111] p-4.5 rounded-[22px] shadow-[0_4px_12px_rgba(26,35,126,0.03)] border border-brand-blue/5 dark:border-white/5 flex flex-col justify-between hover:shadow-[0_10px_25px_rgba(26,35,126,0.08)] transition-all transform hover:-translate-y-1 cursor-pointer"
                    >
                      <div>
