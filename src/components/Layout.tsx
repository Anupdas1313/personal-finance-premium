...
import { LayoutDashboard, BarChart3, Landmark, PieChart, Target, Settings, Plus, MoreHorizontal, BookOpen, FileText, User, ShoppingBag } from 'lucide-react';
...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen bg-white dark:bg-[#060608] flex-col md:flex-row overflow-hidden">
      ...
      {/* Main Content */}
      <main className="flex-1 overflow-y-auto w-full relative z-0" style={{ WebkitOverflowScrolling: 'touch' }}>
