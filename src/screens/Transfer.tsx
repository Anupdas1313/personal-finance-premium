...
export default function Transfer() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-3 sm:py-6 pb-16 animate-in fade-in slide-in-from-bottom-4 duration-700">
      {/* Back Header */}
      <div className="flex items-center gap-3 mb-4">
        <button 
          onClick={() => navigate('/accounts')}
          className="p-1.5 bg-white dark:bg-[#111111] border border-neutral-100 dark:border-white/5 rounded-full hover:bg-neutral-50 dark:hover:bg-white/10 transition-all text-neutral-600 dark:text-neutral-300"
        >
      ...
      {/* Form Container Card */}
      <div className="bg-white dark:bg-[#111111] p-4 sm:p-6 rounded-[24px] shadow-sm border border-neutral-100 dark:border-white/5">
