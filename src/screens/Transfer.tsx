...
export default function Transfer() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 sm:py-12 pb-24 animate-in fade-in slide-in-from-bottom-4 duration-700">
      {/* Back Header */}
      <div className="flex items-center gap-3 mb-8">
        ...
        <button 
          ...
          className="px-4 py-2 bg-white dark:bg-[#111111] border border-neutral-100 dark:border-white/5 rounded-xl text-[10px] font-black text-neutral-600 dark:text-neutral-300 flex items-center gap-1.5 hover:bg-neutral-50 dark:hover:bg-white/10 transition-all uppercase tracking-wider shadow-sm"
        >
      ...
      <div className="bg-white dark:bg-[#111111] p-6 sm:p-8 rounded-[28px] shadow-sm border border-neutral-100 dark:border-white/5">
        <form onSubmit={handleTransfer} className="space-y-6">
          {error && (
            <div className="p-4 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-500 text-[10px] font-bold uppercase tracking-wider">
              {error}
            </div>
          )}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-neutral-50 dark:bg-white/[0.02] border border-neutral-100 dark:border-white/5 rounded-xl outline-none text-xs font-bold text-neutral-800 dark:text-neutral-200 transition-all focus:border-brand-green/30 focus:ring-1 focus:ring-brand-green/30"
                  required
                >
                  {accounts.map(a => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-neutral-400 dark:text-neutral-500 text-xs font-bold">
                  {currency}
                </div>
                <input
                  type="number"
          ...
          <div className="pt-4">
            <button 
              ...
              className="w-full py-3.5 bg-brand-green text-white dark:text-brand-blue rounded-xl text-[10px] font-black uppercase tracking-wider transition-all duration-200 shadow-sm disabled:opacity-50 hover:bg-brand-green/90"
            >
              {isSaving ? 'Processing...' : 'Execute Transfer'}
            </button>
            {accounts.length < 2 && (
               <p className="text-center text-[8px] text-rose-500 mt-3 font-bold uppercase tracking-wider">You need at least 2 accounts to perform a transfer.</p>
            )}
          </div>
        </form>
      </div>
